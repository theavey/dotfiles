# Copied from /share/pkg/gromacs/2016.3/install/bin
# changed unset commands from unset array[index] to array[index] = ()
# loaded with autoload bashcompinit; bashcompinit
# source gmx-autocomplete.bash
# Didn't seem to work, though did help complete first command, but made rest worse
_gmx_anadock_compl() {
local IFS=$'\n'
